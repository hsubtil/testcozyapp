[![Travis build status shield](https://img.shields.io/travis/hsubtil/cozytestapp/master.svg)](https://travis-ci.org/hsubtil/cozytestapp)
[![Github Release version shield](https://img.shields.io/github/tag/hsubtil/cozytestapp.svg)](https://github.com/hsubtil/cozytestapp/releases)
...
```sh
$ git clone https://github.com/hsubtil/cozytestapp.git
$ cd cozytestapp
$ yarn install
```
...
After the build and the stack launched, your app is now available at http://cozytestapp.cozy.tools:8080.
